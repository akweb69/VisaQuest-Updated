...
const Navbar = () => {
    ...
    return (
        <div className={`w-full sticky top-0 z-50 ${!darkMode ? "bg-[rgb(0,0,44)] " : "bg-gray-100"}`}>
            <div className="w-11/12 mx-auto py-4 flex justify-between items-center">
                ...
                <div className="hidden lg:flex">
                    <ul className={`flex ${!darkMode ? " text-white" : "text-black"}`}>
...

                {
                    User && User.email ? <div className='flex gap-4 items-center'>
                        ...
                        {/* theme toggle */}
                        <div onClick={() => setDarkMode(!darkMode)} className="border cursor-pointer border-[rgb(0,0,88)] p-1 hidden lg:flex rounded-full">
                            {
                                !darkMode ? <MdDarkMode className='size-8 rounded-full text-white  bg-[rgb(0,0,37)]' /> : <CiLight className='size-8 rounded-full text-black ' />
                            }
                ...
                <div className="lg:hidden flex">
                    ...
                    {/* theme toggle */}
                    <div onClick={() => setDarkMode(!darkMode)} className=" cursor-pointer  size-12 rounded-full  flex justify-center items-center mx-3">
                        {
                            !darkMode ? <MdDarkMode className='size-8 rounded-full text-white  bg-[rgb(0,0,37)]' /> : <CiLight className='size-8 rounded-full text-black ' />
                        }
