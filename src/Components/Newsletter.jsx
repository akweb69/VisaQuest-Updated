...
import png from "../assets/images/Email campaign-bro.png"

const Newsletter = ({ darkMode }) => {
    return (
        <div className={` ${!darkMode ? "bg-gradient-to-b from-[rgb(0,0,31)] to-[rgb(0,0,44)] text-white" : ""}  pb-20`}>
            ...
            <div className="w-11/12 mx-auto lg:grid grid-cols-2 gap-5 ">
                <div className="w-full">
                    <img src={png} alt="" className="w-1/2 mx-auto " />
                </div>
                <div className="">
                    <motion.div
